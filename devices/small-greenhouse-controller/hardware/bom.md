...
- 電子部品の小計: `約69,800円`
- 温室、ファン、チューブ、タンク、固定材を含めた概算: `約80,000円 から 85,000円`
- 送料は別
- `Adafruit 1150` は Adafruit の現行価格 `$24.95` を `2026-04-03 の USD/JPY 159.62` で円換算した概算を使っている
- `SHT41` も Seeed の現行価格 `$6.50` を同じ為替で円換算した概算を使っている

## 概算

- 価格が固い部材の小計: `約72,700円`
- 温室、ファン、チューブ、固定材を含めた概算: `約81,000円 から 86,000円`
- 送料は別
- `Seeed Studio` の `SHT41` は海外送料が別で乗る可能性がある
